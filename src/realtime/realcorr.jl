...
Base.iszero(x::RealCorrelationFunction) = iszero(x.G₊₊) && iszero(x.G₊₋) && iszero(x.G₋₊) && iszero(x.G₋₋)
...
Base.:-(x::RealCorrelationFunction) = RealCorrelationFunction(-x.G₊₊, -x.G₊₋, -x.G₋₊, -x.G₋₋)
